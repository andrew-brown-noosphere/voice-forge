...
const NewCrawl = () => {
  ...
  const [config, setConfig] = useState({
    ...
    timeout: 30,    // 🔧 FIX: Increased timeout for more complex sites
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              ...
              <TextField
                ...
                inputProps={{ min: 1 }}
                fullWidth
                helperText={config.max_pages ? `Limit to ${config.max_pages} pages` : 'No limit - crawl entire site (recommended)'}
              />
            </Grid>
          ...
          <Grid container spacing={3}>
            <Grid item xs={12}>
              ...
              <TextField
                ...
                helperText="User agent string for the crawler"
              />
            </Grid>
            
            <Grid item xs={12}>
              <Typography gutterBottom>Exclude Patterns</Typography>
            ...
            <Grid item xs={12}>
              <Typography gutterBottom>Include Patterns</Typography>
              <Box sx={{ display: 'flex', alignItems: 'center', mb: 1 }}>
                <TextField
                  fullWidth
                  ...
                  <StepContent>
                    ...
                    <Box sx={{ mb: 2, mt: 3 }}>
                      <div>
                        ...
                        >
                          {index === steps.length - 1 ? 'Start Crawl' : 'Continue'}
                        </Button>
                        <Button
